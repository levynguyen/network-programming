...
public class Server extends javax.swing.JFrame {
    ...
    private String TimViTri(String vanban){
        ...
        char kytu2=vanban.charAt(1);
        int max1=counter[vanban.charAt(0)];
        int max2=counter[vanban.charAt(1)];
       ...
       String chuoi ="Số lần xuất hiện của " + kytu1 + " trong chuỗi:" + max1 + "\n" + "Ký tự " + kytu2 +" xuất hiện nhiều thứ hai trong chuỗi: " + max2;
        return chuoi;
    }
    ...
    private void initComponents() {
        ...
        txtvanban.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        txtvanban.setRows(5);
        ...
        txtgiaima.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        txtgiaima.setRows(5);
    ...
    private void khoitaoServer(){
        try{
            ...
            System.out.println("Đang chờ....."); //lúc đầu server in ra dòng này ạ
            if (server!=null){
            ...
            txttrangthai.setText("Nhận dữ liệu thành công");
